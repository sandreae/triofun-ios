        ...
        navigator.getUserMedia(
            ...
            (function(params){
                ...
                return function(stream) {
                    ...
                    if (initRecorder != undefined) {initRecorder()}
                };
            })(params),
            function(error) {
    ...
    if (path_to_soundfile && buffersrc) {
        fetchSoundFile(path_to_soundfile, function (sndArray) {
            _context.decodeAudioData(sndArray, function (buf) {
                ...
                cracked.soundLoaded(path_to_soundfile)
            }, function (e) {
...
cracked.soundLoaded = function(path_to_soundfile) {
    console.log("soundLoaded Helper")
}
